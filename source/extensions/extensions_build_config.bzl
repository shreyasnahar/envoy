...
EXTENSIONS = {
    ...
    "envoy.filters.http.request_buffer":                "//source/extensions/filters/http/request_buffer:config",
    ...
    "envoy.filters.http.link_id_validation":           "//source/extensions/filters/http/link_id_validation:config",
